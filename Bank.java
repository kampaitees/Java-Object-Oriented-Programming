...
public class Lab63 {
    public static void main(String[] args){
        ...
        System.out.println("Enter Intrest,principal,time");
...
class SBI extends RBI{
    double calulateAmount(){
        return principal*Math.pow((1+intrest/12),12);
    }
}

class ICICI extends RBI{
    double calulateAmount(){
        return principal*Math.pow((1+intrest/6),6*time)+principal*time*intrest;
    }
}
