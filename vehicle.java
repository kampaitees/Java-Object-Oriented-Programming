...
class vehicle {
	public static void main(String [] args) {
		...
		if(choice == 1) {
			...
			System.out.println("Enter Manufacturing Number:");
			int manufactNumber = input.nextInt();
			Car car = new Car(regNumber, mileage, color, ownerName, manufactNumber);
			car.showData();
		}
	}
}
...
class Car extends Vehicle {
	private int manufactNumber;
	
	Car(int regNumber, double mileage, String color, String ownerName, int manufactNumber) {
	...
	void showData() {
		...
		System.out.println("Color: "+this.color);
		System.out.println("OwnerName: "+this.ownerName);
		System.out.println("ManufactNumber "+this.manufactNumber);
		System.out.println("\n");
	}
}	
